...
export const checkName = debounce((electrumClient, doichainAddress, name, totalUtxoValue, totalAmount, callback) => {
    _checkName(electrumClient, doichainAddress, name, totalUtxoValue, totalAmount).then(result => {
 ...
 * @returns the result; currentNameAddress is the address a taken name belongs to
 */
export async function _checkName(electrumClient, doichainAddress, _name, totalUtxoValue, totalAmount) {
