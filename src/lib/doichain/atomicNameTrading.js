...
import { estimateVsize, feeFor, MAX_INPUTS, MIN_RELAY_FEE_RATE, selectCoins } from "$lib/doichain/fees.js";
 ...
 */
export const generateAtomicNameTradingPSBT = (name, fundingUtxos, nameUtxo, buyerAddress, price, storageFee, network, feeRate = MIN_RELAY_FEE_RATE) => {
    ...
    let changeAmount = selection.total + nameOutput.value - sellerReceives - storageFee - transactionFee;
    let dust = 0;
