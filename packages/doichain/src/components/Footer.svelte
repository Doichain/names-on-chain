...
<footer class="border-t border-gray-200 bg-gray-50 px-4 py-4 text-center text-sm text-gray-700">
	...
	<p class="mt-1 flex flex-wrap items-center justify-center gap-x-1.5 text-xs text-gray-600">
		...
		<a class="inline-flex items-center gap-1" href="https://le-space.de" rel="noopener">
			...
			geometry, protected space.

			Canonical source: Le-Space/landing, docs/le-space-brand/logo/svg/
			le-space-mark-heart-light.svg, generated by build_brand.py --marks. It is
			inlined here because the brand package is not published to npm; the shapes
			below are byte-for-byte that file. 22 px is the minimum the brand README
			sets for this variant — the heart needs two more than the mark's 20 to read.
		-->
			<svg
				viewBox="0 0 96 96"
				width="22"
