import { network } from '@names-on-chain/doichain/doichain-store.js'; // import svelte store
import { browser } from '$app/environment'; // if we are not rendering on a server side this is true
import { setupElectrumConnection } from '@names-on-chain/doichain/electrumConnection.js'; // connects and manages the connection to an electrums server
